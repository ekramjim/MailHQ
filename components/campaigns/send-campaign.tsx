      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-card border border-border rounded-2xl shadow-lg w-full max-w-sm p-6 flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              This will send emails to <span className="font-medium text-foreground">{pendingRecipients.length} recipients</span> using your connected Resend account. This cannot be undone.
            </p>
